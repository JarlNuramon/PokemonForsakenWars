...
public class RPGcontroller
{
    ...
    if(spieler1.getLeben()<=0)
     System.out.println(spieler1.getName() + " hat verloren^^"); //Hier soll der Spieler seinen Namen eingesetzt bekommen, weil es sch̦ner ist.Probier es.
     
    if(spieler2.getLeben()<=0)
     System.out.println(spieler2.getName()+" hat verloren^^");//Hier soll der Spieler seinen Namen eingesetzt bekommen, weil es sch̦ner ist.Probier es.
